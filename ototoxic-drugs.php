                    ...
                    <div class="purpose-wrapper">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                ...
                                <ul>
                                    <li>Aspirin and other Non-Steroidal Anti-Inflammatory Drugs (NSAIDs), including ibuprofen and naproxen.</li>
                                    <li>Certain Antibiotics, including ciprofloxacin, doxycycline, gentamicin, erythromycin, tetracycline, tobramycin, and vancomycin.</li>
                                    <li>Certain Cancer medications, including cisplatin and vincristine.</li>
                                    <li>Loop Diuretics (when given intravenously in high doses).</li>
                                    <li>Tricyclic Antidepressants such as amitriptyline, clomipramine, and imipramine.</li>
                                    <li>Antimalarial Drugs such as chloroquine and quinine</li>
                                    <li>Certain Anticonvulsants, including carbamazepine and valproic acid.</li>
                                </ul>
